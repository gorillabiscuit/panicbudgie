/*
 ...
 Vendored from https://github.com/upphiminn/d3.ForceBundle (MIT-licensed) and
 lightly modified for ESM consumption: the IIFE is replaced with a named export,
 and two implicit-global writes (`spring_force`, `electrostatic_force`) are
 declared with `var` so the module works under ES-module strict mode.
*/
